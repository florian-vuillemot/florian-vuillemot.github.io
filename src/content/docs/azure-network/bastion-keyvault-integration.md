...
description: Or why you can't get a permission denied from your browser.
---
...
![Initial setup](../../../assets/azure-network/bastion-keyvault-integration/init-setup.png)
...
![Initial `kvbastionintegration` network](../../../assets/azure-network/bastion-keyvault-integration/init-kv-network.png)
...
![`vm-password` is available](../../../assets/azure-network/bastion-keyvault-integration/secret-available.png)
...
![`kvbastionintegration` network restriction to the subnet](../../../assets/azure-network/bastion-keyvault-integration/kv-with-network-restrictions.png)

Here's what the updated architecture looks like.
![Infrastructure with network restriction](../../../assets/azure-network/bastion-keyvault-integration/infra-network-close.png)
...
![Access denied on `kvbastionintegration` secrets](../../../assets/azure-network/bastion-keyvault-integration/access-deny-on-secrets.png)
...
![Access denied to `kvbastionintegration` - network tram](../../../assets/azure-network/bastion-keyvault-integration/access-deny-on-list.png)

Now, if your IP is allowed to `kvbastionintegration`, you can see the list operation first. 
![Key vault list operation](../../../assets/azure-network/bastion-keyvault-integration/kv-list-operation.png)

Then when retrieving the selected secret.
![Key vault get secret value](../../../assets/azure-network/bastion-keyvault-integration/kv-get-operation.png)
