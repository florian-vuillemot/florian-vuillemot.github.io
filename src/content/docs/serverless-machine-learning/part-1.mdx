...
description: Getting started with the components - Azure Function, GitHub and GitHub Action -.
---
...
![GitHub Repository](../../../assets/serverless-machine-learning/part-1/github-repository.gif)
...
## Step by step
![Global workflow](../../../assets/serverless-machine-learning/part-1/global-workflow.gif)
...
![Create an Azure Function](../../../assets/serverless-machine-learning/part-1/create-fct-app.png)
...
![GitHub configuration](../../../assets/serverless-machine-learning/part-1/grant-deployment-permission.png)
7. The configuration is done, the Azure Function can now be created. ![Configuration review](../../../assets/serverless-machine-learning/part-1/review-before-create-fct-app.png)
...
![GitHub repository files](../../../assets/serverless-machine-learning/part-1/files-in-repository.png)
> The [next article](./part-2) will deep dive into this file.
...
![GitHub Action panel](../../../assets/serverless-machine-learning/part-1/github-actions-panel.png)

This workflow contains steps defined in the workflow configuration.
![GitHub Workflow](../../../assets/serverless-machine-learning/part-1/github-action-workflow.png)

# Summary and next step
This article gives the reader the basic knowledge to deploy a basic machine learning application. However, this simple example does not allow the deployment of a real machine learning model! And that will be the focus of the [next article](./part-2).
