...
# Current status
The [previous article](./part-3) leads to these files:
...
![Deployment slot demo](../../../assets/serverless-machine-learning/part-4/create-slot.gif)
...
![Entra app](../../../assets/serverless-machine-learning/part-4/create-app.gif)

Then, allow the Microsoft Entra application to deploy on both Azure Function deployment slots:
![App permission](../../../assets/serverless-machine-learning/part-4/app-permissions.gif)

Then, allow GitHub Action to use the identity:
![Federated identity](../../../assets/serverless-machine-learning/part-4/federated.gif)

Now, on GitHub, add the Microsoft Entra application information:
![GitHub secrets](../../../assets/serverless-machine-learning/part-4/workflow-identity.gif)
...
Where `az-fct-python-ml_group` and `az-fct-python-ml` are, respectively, the Ressource Group and the Azure Function created during the [step 1](./part-4) of this guide.
...
![Rollback](../../../assets/serverless-machine-learning/part-4/rollback.gif)
...
![App settings](../../../assets/serverless-machine-learning/part-4/app-settings.gif)

# Summary and next step
We can now quickly revert to the previous version of our application. But in fact, we're deploying an API that doesn't need updating: we're updating its model without touching the API code. The [following article](./part-5) focuses on remote model storage, limiting infrastructure updates to each version.
