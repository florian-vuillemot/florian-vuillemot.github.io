...
## Building a Private Cloud at Home (with Raspberry Pi)

**Summary:**
This post is about my journey building a small private cloud at home using Raspberry Pi computers and k3s. It’s not just about learning real hardware, but about going further and deeper into the technology, understanding what is really behind the cloud, and connecting theory to practice.
...
## Project Context: Helping Researchers
...
This is just the beginning of my private cloud journey. I hope my experience will help others who want to learn more about real hardware and cloud technologies. If you are interested, follow my blog for the next part!
