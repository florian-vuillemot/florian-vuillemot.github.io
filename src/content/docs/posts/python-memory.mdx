...
After this change, the memory usage graph looked like this:

![New memory usage graph](../../../assets/posts/python-memory/memory-percentage-steps.png)
*Figure: Memory usage after scoping.*
